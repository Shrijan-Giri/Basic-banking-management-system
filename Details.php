...
<head>
  ...
  <style>
    ...
    th {
      /* customer details ki heading ka color */
      background: skyblue;
      color: white;
    }
...
<body>
  ...
  <table>
    ...
    $username = "root";
    $password = "";
    $conn = mysqli_connect($server, $username, $password, "shrijan");
    if (!$conn) {
    ...
    if (isset($_SESSION['user'])) {
      ...
      while ($row = mysqli_fetch_array($result)) {
        ...
        echo "<td>" . $row["accountno"] . "</td><td>" . $row["name"] . "</td>
    ...
    ?>
    <div style="font-family: 'skyblue',serif;   font-size: 40px;
    text-align: center;
    margin: 20px;
}">
    ...
    <div class="card container">
      ...
      <form action="transfer.php" method="POST">
        ...
        <select name="reciever" id="dropdown" class="textbox" required>
          ...
          <?php
          $db = mysqli_connect("localhost", "root", "", "shrijan");
        ...
        <br><br>
        <b> From</b>&nbsp&nbsp&nbsp&nbsp :&nbsp&nbsp <span style="font-size:1.2em;">
        <input id="myinput" name="sender" class="textbox" disabled type="text" value='<?php echo "$user"; ?>'>
      </input></span>
        <br><br>
    ...
    <div style="font-family:'Georgia';font-size: 40px;
    text-align: center;
    margin: 20px;
}">
